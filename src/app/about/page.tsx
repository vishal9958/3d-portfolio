...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/bappaditya-biswas/",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/vishal9958",
...
const TOOLS = [
  ...
  },
  {
    name: "SQL",
    content: "Next.js is a React framework for production",
    icon: <DiSql size={"50px"} color="#fff" />,
    color: "#000000",
  },
  {
    name: "Prettier",
  ...
  {
    name: "Canva",
    content: "Use for designing the work",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Bappaditya Biswas</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Bappaditya, a Fullstack developer passionate about
