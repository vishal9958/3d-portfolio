...
/* ✅ helper: string | Date ko safely Date banane ke liye */
        ...
        <div className="p-4 space-y-0">
              ...
              >
                ...
                {isSingleUser && (
                  <span className="block mt-2 text-yellow-600 dark:text-yellow-400/80 text-xs">
                    (It's just you right now, invite a friend!)
                  </span>
                )}
              </p>
            </div>
          ...
          {msgs.map((msg, i) => {
            ...
            const showHeader =
              ...
              differenceInMinutes(
                toDate(msgs[i].createdAt),
                toDate(msgs[i - 1].createdAt)
              ) > 3;
